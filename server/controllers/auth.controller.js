            ...
            <table style="min-width:320px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#eaeced">
              ...
              <td class="wrapper" style="padding:0 10px;">
                ...
                <tr>
                  ...
                  <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                    <tr>
                    <td class="img-flex"><img src="https://drive.google.com/uc?export=view&id=1x09lvv3sDD5aHHskm0pKjsu78O_ZZvU8" style="vertical-align:top;" width="600" height="306" alt="" /></td>
                    </tr>
                    <tr>
                      ...
                      <tr>
                        ...
                        <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                          ...
                          <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#ed3636">
                            <a target="_blank" style="text-decoration:none; color:#ffffff; display:block; padding:12px 10px 10px;" href="${process.env.CLIENT_URL}/api/users/activate/${token}">Activate Account</a>
                          </td>
                          </tr>
                        </table>
                        </td>
